...
class User(Base):
    ...
    nutritionist_profile = relationship(
        "NutritionistProfile", back_populates="user", uselist=False
    )

    __table_args__ = (CheckConstraint("role IN ('patient', 'nutritionist', 'admin')"),)
...
class PatientProfile(Base):
    ...
    __table_args__ = (
        ...
        Index(
            "idx_patient_health_goal",
            "health_goal",
            postgresql_using="gin",
            postgresql_ops={"health_goal": "gin_trgm_ops"},
        ),
    )
...
class NutritionistProfile(Base):
    ...
    __table_args__ = (
        ...
        Index(
            "idx_nutritionist_specializations",
            "specializations",
            postgresql_using="gin",
        ),
        Index("idx_nutritionist_rating", "rating"),
    )
